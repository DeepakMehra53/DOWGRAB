    ...
    <section className="py-5 ">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-4">
          ...
          <p>
            By accessing and using Mowga, you accept and agree to be bound by
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            materials (information or software) on Mowga for personal,
        ...
        <div className="mb-4">
          ...
          <p>
            The materials on Mowga are provided on an "as is" basis. Mowga makes
        ...
        <div className="mb-4">
          ...
          <p>
            In no event shall Mowga or its suppliers be liable for any damages
            (including, without limitation, damages for loss of data or profit,
            or due to business interruption) arising out of the use or inability
            to use the materials on Mowga.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p>
            The materials appearing on Mowga could include technical,
            typographical, or photographic errors. Mowga does not warrant that
        ...
        <div className="mb-4">
          ...
          <p>
            Mowga has not reviewed all of the sites linked to its website and is
            not responsible for the contents of any such linked site. The
            inclusion of any link does not imply endorsement by Mowga of the
            site.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p>
            Mowga may revise these terms of use for its website at any time
